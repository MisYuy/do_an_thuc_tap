                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src="img/vegetable-item-3.png" className="img-fluid me-5 rounded-circle" style={{ width: '80px', height: '80px' }} alt="Vegetable Item 3" />
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src="img/vegetable-item-5.jpg" className="img-fluid me-5 rounded-circle" style={{ width: '80px', height: '80px' }} alt="Vegetable Item 5" />
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src="img/vegetable-item-2.jpg" className="img-fluid me-5 rounded-circle" style={{ width: '80px', height: '80px' }} alt="Vegetable Item 2" />
                                    </div>
                                </th>
                                <td>
